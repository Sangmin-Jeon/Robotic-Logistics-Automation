    ...
    while True:
        ...
        if len(corners) > 0:
            ...
            for (marker_corner, marker_id) in zip(corners, ids):
                ...
                # Display the corner coordinates on the frame
                cv2.putText(frame, f"TL: {top_left}", (top_left[0] - 50, top_left[1] - 20),
                            cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), 2)
                cv2.putText(frame, f"TR: {top_right}", (top_right[0] + 10, top_right[1] - 20),
                            cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), 2)
                cv2.putText(frame, f"BR: {bottom_right}", (bottom_right[0] + 10, bottom_right[1] + 20),
                            cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), 2)
                cv2.putText(frame, f"BL: {bottom_left}", (bottom_left[0] - 50, bottom_left[1] + 20),
                            cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), 2)
                ...
                cv2.putText(frame, f"ID: {marker_id}", (top_left[0], top_left[1] - 40),
